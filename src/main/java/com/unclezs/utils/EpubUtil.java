...
public class EpubUtil {
    ...
    private static void toeBook(String path, String savePath, Article article) {
        ...
        //创建基本的文件
        FileUtil.writeUtf8String(FileUtil.readString(EpubUtil.class.getResource("/templates/epub/container.xml"), Charsets.UTF8), savePath + CONTAINER);
    ...
    public static File toMobi(String path, String savePath, Article article, boolean rename) throws Exception {
        ...
        File targetFile = com.unclezs.utils.FileUtil.checkExistAndRename(savePath + article.getTitle().concat(".mobi"), rename);
    ...
    public static void main(String[] args) throws Exception {
        toMobi("D:\\java\\NovelHarvester\\完美世界.txt", "D:\\java\\NovelHarvester\\tmp\\1.txt", new Article(""), false);
    }
}
