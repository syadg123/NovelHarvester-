...
//        qgLink.setOnAction(e -> DesktopUtil.openBrowse("https://shang.qq.com/wpa/qunwpa?idkey=e49493cef7cb08f05a60d84feed2338ddbde2930cae9deac75b7f3b7f4fac697"));
//        box.getChildren().add(qgBox);
     ...
     */
    public void none() {
        AlertUtil.alert("免责声明", "软件仅供技术交流，请勿用于商业及非法用途，\n" + "如产生法律纠纷与本人无关，如有侵权请联系我删除.");
    }
