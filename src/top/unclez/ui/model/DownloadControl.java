...
import top.unclez.ui.view.stage.Reader;
import top.unclez.ui.view.stage.Setting;
...
public class Control implements Initializable {
    ...
    public void initialize(URL locations, ResourceBundle resources) {
        ...
        search.setGraphic(new ImageView(new Image(ResourceLoader.getImage("search.png"))));
