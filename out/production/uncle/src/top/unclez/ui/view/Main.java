...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        Label lbTitle = new Label("Uncle小说");
        lbTitle.setFont(new Font(16));
        lbTitle.setTextFill(Color.WHITE);
        ImageView imageView=new ImageView("/image/icon.jpg");
        imageView.setFitHeight(25);
        imageView.setFitWidth(25);
        lbTitle.setGraphic(imageView);
        Button btnMin = new Button("",new ImageView("/image/min.jpg"));
        btnMin.setId("btnMin");
        Button btnMax = new Button("",new ImageView("/image/max.jpg"));
        btnMax.setId("btnMax");
        Button btnClose = new Button("",new ImageView("/image/close_on.jpg"));
        btnClose.setId("btnClose");
        Button btnTop=new Button("",new ImageView("/image/top.jpg"));
        btnTop.setId("btnTop");
        gpTitle.add(lbTitle, 0 , 0);
        gpTitle.add(btnTop,1,0);
        gpTitle.add(btnMin, 2, 0);
        gpTitle.add(btnMax, 3, 0);
        gpTitle.add(btnClose, 4, 0);
        ...
        root.setCenter(pane);
        root.setStyle("-fx-background-color: white ;-fx-border-color: #707070; -fx-border-width: 1;");
        gpTitle.setStyle("-fx-background-color: #707070;");
        ...
        btnTop.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                istop=!istop;
                if(istop)
                btnTop.setGraphic(new ImageView("/image/top.jpg"));
                else
                btnTop.setGraphic(new ImageView("/image/top_no.jpg"));
        ...
        StageUtil.showStage(primaryStage,scene);
    }
}
